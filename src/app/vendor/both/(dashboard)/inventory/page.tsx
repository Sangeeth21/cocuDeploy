...
export default function VendorInventoryPage() {
    ...
    return (
        <div>
            <div className="mb-8">
                <h1 className="text-3xl font-bold font-headline">Personalized Retail Inventory</h1>
                <p className="text-muted-foreground">Track and update your product stock levels for direct customer sales.</p>
            </div>
            <Card>

...
export const mockUsers: User[] = [
    ...
    { 
        ...
        avatar: 'https://placehold.co/40x40.png',
        vendorDetails: { address: { fullAddress: '123 Vendor Ave, Delhi', pincode: '110030' } }
    },

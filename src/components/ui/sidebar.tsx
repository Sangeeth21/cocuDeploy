        ...
        <div
          className={cn(
            ...
            variant === "floating" || variant === "inset"
              ...
              : "group-data-[state=collapsed]:w-[var(--sidebar-width-icon)] group-data-[side=left]:border-r group-data-[side=right]:border-l",
            className
          )}
        >
          <div
